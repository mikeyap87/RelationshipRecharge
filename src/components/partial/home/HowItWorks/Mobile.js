...
function Mobile({ how_it_works, early_education }) {
    return (
        <section id="how-it-works" >
            ...
            <p className='text-center sub-heading mb-4 mx-lg-0 mx-5'>5 Simple Steps to Strengthen Your Relationship</p>
            <Slider settings={settings} slides={how_it_works} />
            <div className='bottom-content'>
                <div className='d-flex justify-content-center'>
                    <h1 className='heading text-center fw-bold mt-2 mb-5 mx-lg-0 mx-5'>Why Choose Us for Your Journey Towards Relationship Success?</h1>
                </div>
            </div>
